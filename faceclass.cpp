...
extern void smartdect(bool dect_face = false, bool dect_pedestrian = true, bool save_videobool = false, bool showforeground = false, bool use_camshift = true);//参数为人脸模型及该模型的序号
